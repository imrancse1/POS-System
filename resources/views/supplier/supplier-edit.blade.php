         ...
         <div class="box-tools pull-right">
               ...
               <div class="box-body">
                  <div class="row">
                     <div class="col-md-12">
                        @if($suppliers)
                        <form action="{{route('supplier.update-supplier.post',$suppliers->supplier_id)}}" id="myForm" role="form" data-toggle="validator" method="post" accept-charset="utf-8" novalidate="true" enctype="multipart/form-data">
                           {{csrf_field()}}
                           <!-- SmartWizard html -->
                                    ...
                                    <div id="form-step-0" role="form" data-toggle="validator">
                                        ...
                                        <div class="form-group">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <input type="text" class="form-control" name="supplier_name" id="supplier_name" value="{{$suppliers->supplier_name}}">
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                            <label for="supplier_address" class="col-md-2">Supplier Address :</label>
                                                            <div class="col-sm-4">
                                                                <input type="text" class="form-control" name="supplier_address" id="supplier_address" value="{{$suppliers->supplier_address}}">
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <input type="text" class="form-control" name="supplier_phone" id="supplier_phone" value="{{$suppliers->supplier_phone}}">
                                                                <div class="help-block with-errors"></div>
                                                            </div>
