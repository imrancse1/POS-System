                                ...
                                <table id="employeeDataTable" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Employee Target Set</th>
                                            <th>Employee Sales History</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$employee->vendor_area}}</td>
                                            <td>{{$employee->vendor_zone}}</td>
                                            <td>{{$employee->employee_designation}}</td>
                                            <td>{{$employee->employee_target_set}}</td>
                                            <td>{{$employee->employee_sales_history}}</td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('edit-employee',$employee->employee_id)}}" class="btn btn-info btn-xs edit-personal-info" id="reference_">
                                                ...
                                                <a href="{{route('delete-employee',$employee->employee_id)}}" onclick="return confirm('If you want to delete this item Press OK')" class="btn btn-danger btn-xs edit-personal-info" id="reference_">
                        ...
                        <div id="form-step-0" role="form" data-toggle="validator">
                             ...
                             <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="employee_name" id="employee_name" placeholder="Write your employee name">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="employee_phone" id="employee_phone" placeholder="Write your employee phone number">
                                        <div class="help-block with-errors"></div>
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="employee_code" id="employee_code" placeholder="Write your employee code">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <option value="">===Select Area===</option>
                                            ...
                                            <option value="{{$vendors->vendor_id}}">{{$vendors->vendor_area}}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="employee_designation" id="employee_designation" placeholder="Write your employee designation">
                                        <div class="help-block with-errors"></div>
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="employee_target_set" id="employee_target_set" placeholder="Write your employee target set">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="employee_sales_history" id="employee_sales_history" placeholder="Write your employee sales history">
                                        <div class="help-block with-errors"></div>
                                    </div>
