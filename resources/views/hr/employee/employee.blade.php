                    ...
                    if (data.length > 0) {
                        $.each(data, function(index, value) {
                            if (value.marital_status == 1) {
                                ...
                                var result = "Unmarried";
                            }

                            if (value.status == 1) {
                                var result2 = '<label class="btn btn-success btn-xs">Active</label>';
                            } else {
                                var result2 = '<label class="btn btn-warning btn-xs">Active</label>';
                            }

                            append += '<tr>' +
                                '<td>' + value.personal_info_id + '</td>' +
                                '<td>' + value.name + '</td>' +
                                ...
                                '<td>' + value.dob + '</td>' +
                                '<td>' + result + '</td>' +
                                '<td>' + value.job_designation + '</td>' +
                                '<td><img src="' + img + value.image_path + '"/></td>' +
                                '<td>' + result2 + '</td>' +
                                '<td>' +
                                '<a href="' + edit + value.personal_info_id + '" class="btn btn-info btn-xs edit-personal-info"><i class="fa fa-edit" title="Edit"></i></a>&nbsp' +
                                '<a href="' + view + value.personal_info_id + '" class="btn btn-primary btn-xs"><i class="fa fa-street-view" title="View"></i></a>' +
                                '</td>' +
