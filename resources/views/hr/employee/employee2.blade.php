                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <table id="employeeDataTable" class="table table-bordered table-striped">
                           ...
                           <tbody>
                              @if(count($personalInforations) > 0)
                              @foreach($personalInforations as $key=> $personalInforation)
                              <tr>
...
<script type="text/javascript">
   // $('.stdImage').html('<img src="' + url + '/' + value.std_profile_image + '" class="img imng-responsive img-thubnail" height="120" width="100">');
   ...
   success:function(data)
   {
    ...
    if(data.length > 0)
    {
     ...
     for(var i = 0; i < data.length; i++)
     {
      ...
      output += '<td>'; 
               if(data[i].status == 1){
                output += '<a href="javascript:;" class="btn btn-success btn-xs" style="display:none;" onclick="updateStatus('url', 'active', '+data[i].personal_info_id+')">' +
                  '<i class="fa fa-ban" title="active"></i>'+   
               '</a>&nbsp';
                } else {
                 output+= '<a href="javascript:;" class="btn btn-warning btn-xs" style="display:none;" onclick="updateStatus('url', 'inactive', '+data[i].personal_info_id+')">' +
                           '<i class="fa fa-check-square-o" title="Inactive"></i>'+   
                        '</a>&nbsp';
                }
         output+= '<a href="'+edit+data[i].personal_info_id+'" class="btn btn-info btn-xs edit-personal-info" id="reference_'+data[i].personal_info_id+'">' +
           ...
           output += '<a href="javascript:;" class="btn btn-primary btn-xs reset" style="display: none;">' +
            ...
            if(data[i].status == 2){
                  var result = 'delete';
                output += '<a href="javascript:;" class="btn btn-danger btn-xs" style="'+result+'display:none;" onclick="updateStatus('url', 'delete','+data[i].personal_info_id+')">' +
                  '<i class="fa fa-trash" title="delete"></i>'+   
               '</a>&nbsp';
               }
...
function updateStatus(url,action,id)
{
   alert('ok');
}
