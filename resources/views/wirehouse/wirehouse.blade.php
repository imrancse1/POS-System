                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table id="employeeDataTable" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        @foreach($wirehouses as $key=>$wirehouse)
                                        <tr>
                                            <td>{{$key + 1}}</td>
                                            <td>{{$wirehouse->wirehouse_name}}</td>
                                            <td>{{$wirehouse->wirehouse_address}}</td>
                                            <td>{{$wirehouse->wirehouse_discription}}</td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('wirehouse-edit',$wirehouse->wirehouse_id)}}" class="btn btn-info btn-xs edit-personal-info" id="reference_">
                                                ...
                                                <!-- <a href="javascript:;" class="btn btn-danger btn-xs" style="" onclick="updateStatus('personal-info', 'delete',">
                                                  ...
                                                  <a href="{{route('wirehouse-delete',$wirehouse->wirehouse_id)}}" onclick="return confirm('If you want to delete this item Press OK')" class="btn btn-danger btn-xs edit-personal-info" id="reference_">
            ...
            <div class="tab-pane" id="add-info">
                <div class="box box-default">
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form action="{{route('wirehouse.save-wirehouse.post')}}" id="myForm" role="form" data-toggle="validator" method="post" accept-charset="utf-8" novalidate="true" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    <!-- SmartWizard html -->
                                                ...
                                                <div id="form-step-0" role="form" data-toggle="validator">
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <input type="text" class="form-control" name="wirehouse_name" id="wirehouse_name" placeholder="Write your Wirehouse Name">
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                            <label for="wirehouse_address" class="col-md-2">Wirehouse Address :</label>
                                                            <div class="col-sm-4">
                                                                <input type="text" class="form-control" name="wirehouse_address" id="wirehouse_address" placeholder="Write your wirehouse address">
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <input type="text" class="form-control" name="wirehouse_discription" id="wirehouse_discription" placeholder="Write your wirehouse discription">
                                                                <div class="help-block with-errors"></div>
                                                            </div>
